...
import eproxy_pb2 as eproxy__pb2
...
class DataTransferServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.push = channel.stream_unary(
        ...
        request_serializer=eproxy__pb2.Packet.SerializeToString,
        response_deserializer=eproxy__pb2.Metadata.FromString,
        )
    self.pull = channel.unary_stream(
        '/com.webank.ai.eggroll.api.networking.proxy.DataTransferService/pull',
        request_serializer=eproxy__pb2.Metadata.SerializeToString,
        response_deserializer=eproxy__pb2.Packet.FromString,
        )
    ...
    self.polling = channel.stream_stream(
        ...
        request_serializer=eproxy__pb2.PollingFrame.SerializeToString,
        response_deserializer=eproxy__pb2.PollingFrame.FromString,
        )
...
def add_DataTransferServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'push': grpc.stream_unary_rpc_method_handler(
          servicer.push,
          request_deserializer=eproxy__pb2.Packet.FromString,
          response_serializer=eproxy__pb2.Metadata.SerializeToString,
      ),
      'pull': grpc.unary_stream_rpc_method_handler(
          servicer.pull,
          request_deserializer=eproxy__pb2.Metadata.FromString,
          response_serializer=eproxy__pb2.Packet.SerializeToString,
      ),
      ...
      'polling': grpc.stream_stream_rpc_method_handler(
          servicer.polling,
          request_deserializer=eproxy__pb2.PollingFrame.FromString,
          response_serializer=eproxy__pb2.PollingFrame.SerializeToString,
      ),
  }
...
class RouteServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.query = channel.unary_unary(
        ...
        request_serializer=eproxy__pb2.Topic.SerializeToString,
...
def add_RouteServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'query': grpc.unary_unary_rpc_method_handler(
          servicer.query,
          request_deserializer=eproxy__pb2.Topic.FromString,
